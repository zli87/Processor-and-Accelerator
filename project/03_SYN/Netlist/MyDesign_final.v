...
module MyDesign ( dut_run, dut_busy, reset_b, clk, dut_sram_write_address, 
  ...
  wire   n1659, n1660, n1661, n1662, n1663, n1664, flag_last, flag_r, n456,
         n457, n458, n459, n460, n461, n462, n463, n464, n465, n520, n521,
         ...
         n632, n634, n635, n636, n637, n638, n639, n640, n641, n642, n643,
         ...
         n745, n746, n747, n748, n749, n750, n751, n752, n753, n754, n756,
         ...
         n834, n835, n836, n837, n838, n839, n840, n841, n842, n844, n845,
         ...
         n1291, n1292, n1293, n1294, n1295, n1296, n1297, n1298, n1304, n1306,
         ...
         n1377, n1387, n1388, n1389, n1390, n1391, n1392, n1393, n1394, n1395,
  ...
  DFF_X1 clk_r_REG109_S1 ( .D(sram_dut_read_data[7]), .CK(clk), .Q(n1557), 
        .QN(n647) );
  DFF_X1 clk_r_REG115_S3 ( .D(n1556), .CK(clk), .Q(n1555), .QN(n1339) );
  DFF_X1 clk_r_REG118_S1 ( .D(sram_dut_read_data[6]), .CK(clk), .Q(n1554), 
        .QN(n1350) );
  ...
  DFF_X1 clk_r_REG153_S1 ( .D(sram_dut_read_data[2]), .CK(clk), .Q(n1542) );
  DFF_X1 clk_r_REG154_S2 ( .D(n1542), .CK(clk), .Q(n1541) );
  DFF_X1 clk_r_REG159_S3 ( .D(n1541), .CK(clk), .Q(n1540), .QN(n726) );
  DFF_X1 clk_r_REG162_S1 ( .D(sram_dut_read_data[1]), .CK(clk), .Q(n1539), 
        .QN(n741) );
  DFF_X1 clk_r_REG163_S2 ( .D(n1539), .CK(clk), .Q(n1538) );
  DFF_X1 clk_r_REG165_S1 ( .D(sram_dut_read_data[0]), .CK(clk), .Q(n1536), 
        .QN(n747) );
  ...
  DFFS_X2 clk_r_REG169_S1_IP ( .D(n1653), .CK(clk), .SN(n1388), .Q(n1354), 
        .QN(n1532) );
  DFFR_X1 R_2_clk_r_REG175_S1 ( .D(wmem_dut_read_data[2]), .CK(clk), .RN(n1388), .Q(n1528), .QN(n745) );
  ...
  DFFR_X2 clk_r_REG177_S1 ( .D(wmem_dut_read_data[0]), .CK(clk), .RN(n1387), 
        .Q(n898), .QN(n1344) );
  DFF_X2 clk_r_REG100_S1 ( .D(sram_dut_read_data[8]), .CK(clk), .Q(n1560) );
  DFF_X2 clk_r_REG144_S1 ( .D(sram_dut_read_data[3]), .CK(clk), .Q(n1545), 
        .QN(n648) );
  DFFR_X2 clk_r_REG176_S1 ( .D(wmem_dut_read_data[1]), .CK(clk), .RN(n1387), 
        .Q(n644), .QN(n897) );
  DFFR_X2 R_4_clk_r_REG172_S1 ( .D(wmem_dut_read_data[5]), .CK(clk), .RN(n1387), .Q(n1530), .QN(n749) );
  DFF_X2 clk_r_REG112_S2 ( .D(n1610), .CK(clk), .Q(n1495) );
  DFF_X2 clk_r_REG136_S2 ( .D(n1548), .CK(clk), .Q(n1547) );
  DFFR_X2 clk_r_REG173_S1 ( .D(wmem_dut_read_data[4]), .CK(clk), .RN(n1387), 
        .Q(n650), .QN(n754) );
  DFF_X2 clk_r_REG72_S4 ( .D(n1640), .CK(clk), .Q(n1458) );
  DFF_X2 clk_r_REG122_S2 ( .D(n1608), .CK(clk), .Q(n1492) );
  DFFR_X1 clk_r_REG174_S1 ( .D(wmem_dut_read_data[3]), .CK(clk), .RN(n1387), 
        .Q(n1529), .QN(n736) );
  ...
  DFFRS_X1 clk_r_REG21_S3 ( .D(n1663), .CK(clk), .RN(n1388), .SN(1'b1), .QN(
        n1316) );
  DFF_X1 clk_r_REG126_S1 ( .D(sram_dut_read_data[5]), .CK(clk), .Q(n1551) );
  DFF_X1 clk_r_REG164_S3 ( .D(n1538), .CK(clk), .Q(n1537), .QN(n729) );
  DFFR_X2 clk_r_REG171_S1 ( .D(wmem_dut_read_data[6]), .CK(clk), .RN(n1387), 
        .Q(n1531), .QN(n1377) );
  DFF_X2 R_0_clk_r_REG149_S2 ( .D(n804), .CK(clk), .Q(n643) );
  DFFR_X2 R_3_clk_r_REG175_S1 ( .D(wmem_dut_read_data[2]), .CK(clk), .RN(n1387), .Q(n1103) );
  DFFR_X2 R_5_clk_r_REG172_S1 ( .D(wmem_dut_read_data[5]), .CK(clk), .RN(n1387), .Q(n672) );
  DFFR_X2 clk_r_REG168_S1 ( .D(wmem_dut_read_data[8]), .CK(clk), .RN(n1387), 
        .Q(n1533), .QN(n638) );
  ...
  INV_X2 U609 ( .A(sram_dut_read_data[4]), .ZN(n1389) );
  INV_X2 U610 ( .A(wmem_dut_read_data[7]), .ZN(n1653) );
  ...
  INV_X1 U1312 ( .A(sram_dut_read_data[2]), .ZN(n1137) );
